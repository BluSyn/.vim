...
if has("gui_running")
	...
	" -> Tabs
	hi TabLine        guibg=#141414 guifg=#000000 gui=none
	hi TabLineFill    guibg=#333333 guifg=#777777 gui=none
...
elseif &t_Co == 256
	...
	" -> Tabs
	hi TabLine        ctermbg=232  ctermfg=234   cterm=none
	hi TabLineFill    ctermbg=234  ctermfg=252   cterm=bold
